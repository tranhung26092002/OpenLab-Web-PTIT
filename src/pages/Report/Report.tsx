...
const Report = () => {
    ...
    const renderStudentInfo = (reports: any, currentPage: any, studentsPerPage: any) => {
        ...
        return (
            <Fragment>
                <h2 className={styles.SectionTitle}>Thông tin sinh viên</h2>
                ...
                <div>
                    ...
                    <div className={styles.FormContainer}>
                        <Form layout="vertical">
                            ...
                            <Row gutter={[16, 16]}>
                                <Col span={24}>
                                    <h3 className={styles.ContentTitle}>Nội dung các bài thực hành:</h3>                                    <List
                                        bordered
    ...
    return (
        <Fragment>
            <Header />
            <div>
                <h2 className={styles.MainTitle}>Báo cáo thực hành</h2>
